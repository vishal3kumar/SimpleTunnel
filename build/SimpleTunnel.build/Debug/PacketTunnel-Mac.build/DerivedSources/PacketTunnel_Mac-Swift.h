...
#ifndef PACKETTUNNEL_MAC_SWIFT_H
#define PACKETTUNNEL_MAC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PacketTunnel_Mac",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// An object used to tunnel IP packets using the SimpleTunnel protocol.
SWIFT_CLASS("_TtC16PacketTunnel_Mac22ClientTunnelConnection")
...
SWIFT_CLASS("_TtC16PacketTunnel_Mac20PacketTunnelProvider")
