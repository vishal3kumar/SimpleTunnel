...
#ifndef TUNNEL_SERVER_SWIFT_H
#define TUNNEL_SERVER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="tunnel_server",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// A logical connection (or flow) of network data in the SimpleTunnel protocol.
SWIFT_CLASS("_TtC13tunnel_server10Connection")
...
SWIFT_CLASS("_TtC13tunnel_server16ServerConnection")
@interface ServerConnection : Connection <NSStreamDelegate>
@end
...
SWIFT_CLASS("_TtC13tunnel_server14ServerDelegate")
...
SWIFT_CLASS("_TtC13tunnel_server6Tunnel")
...
SWIFT_CLASS("_TtC13tunnel_server12ServerTunnel")
@interface ServerTunnel : Tunnel <NSStreamDelegate>
...
SWIFT_CLASS("_TtC13tunnel_server22ServerTunnelConnection")
@interface ServerTunnelConnection : Connection
@end



/// An object representing the server side of a logical flow of UDP network data in the SimpleTunnel tunneling protocol.
SWIFT_CLASS("_TtC13tunnel_server19UDPServerConnection")
@interface UDPServerConnection : Connection
@end
